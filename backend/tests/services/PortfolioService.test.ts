...
describe('PortfolioService', () => {
  ...
  describe('createPortfolio', () => {
    it('should throw an error if the portfolio already exists', async () => {
      ...
      await expect(service.createPortfolio('Portfolio 1', 'url')).rejects.toThrow('Portfolio already exists');
    });

    it('should create a new portfolio and its draft version', async () => {
